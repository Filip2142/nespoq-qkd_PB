 ...
 */
#ifndef AODVQPACKET_H
#define AODVQPACKET_H
...
#define AODVQ_TYPE_HEADER_PROTOCOL_NUMBER 171
#define AODVQ_RREQ_HEADER_PROTOCOL_NUMBER 172
#define AODVQ_RREP_HEADER_PROTOCOL_NUMBER 173 
#define AODVQ_RREP_ACK_HEADER_PROTOCOL_NUMBER 174
#define AODVQ_RERR_HEADER_PROTOCOL_NUMBER 175
/**
* \ingroup aodvq
...
enum MessageType
{
  AODVQTYPE_RREQ  = 1,   //!< AODVQTYPE_RREQ
  AODVQTYPE_RREP  = 2,   //!< AODVQTYPE_RREP
  AODVQTYPE_RERR  = 3,   //!< AODVQTYPE_RERR
  AODVQTYPE_RREP_ACK = 4 //!< AODVQTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the AODVQ RREQ type
   */
  TypeHeader (MessageType t = AODVQTYPE_RREQ);
...
public:
   ...
   */
   RreqHeader (uint8_t flags = 0, uint8_t reserved = 0, uint8_t hopCount = 0,
              ...
              uint32_t originSeqNo = 0, uint32_t L = 0, uint32_t L_summary = 0);
...
public:
  ...
  RrepHeader (uint8_t prefixSize = 0, uint8_t hopCount = 0, Ipv4Address dst =
                ...
                Ipv4Address (), Time lifetime = MilliSeconds (0), uint32_t L = 0, uint32_t L_summarry = 0);
  /**
   * \brief Get the type ID.
   * \return the object TypeId
   */
