 ...
 */
#ifndef AODVQ_RTABLE_H
#define AODVQ_RTABLE_H
...
public:
  ...
  RoutingTableEntry (Ptr<NetDevice> dev = 0,Ipv4Address dst = Ipv4Address (), bool vSeqNo = false, uint32_t seqNo = 0,
                     ...
                     Ipv4Address nextHop = Ipv4Address (), Time lifetime = Simulator::Now (), uint32_t L_summary = 0);
...
private:
  ...
  */
  ...
  uint32_t m_L_summary;
};

/**
 * \ingroup aodvq
 * \brief The Routing table used by AODVQ protocol
 */
class RoutingTable
{
public:
   ...
   * \return true on success
   */
  bool LookupRoute (Ipv4Address dst, std::vector<RoutingTableEntry> & rt);
  bool LookupRoute1 (Ipv4Address dst, RoutingTableEntry & rt);
   ...
   * \return true on success
   */
  bool LookupValidRoute (Ipv4Address dst, std::vector<RoutingTableEntry> & rt);
  bool LookupValidRoute1 (Ipv4Address dst, RoutingTableEntry & rt);
  /**
  ...
  std::map<Ipv4Address, std::vector<RoutingTableEntry>> GetRoutes(){
...
private:
  ...
  std::map<Ipv4Address, std::vector<RoutingTableEntry>> m_ipv4AddressEntry;
   ...
   */
  void Purge (std::map<Ipv4Address, std::vector<RoutingTableEntry>> &table) const;
};

}  // namespace aodvq
}  // namespace ns3

#endif /* AODVQ_RTABLE_H */
