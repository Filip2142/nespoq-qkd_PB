...
void QKDChargingApplication::StartApplication (void) // Called at time specified by Start
{
  ...
  m_sendSocket->SetIpTtl (30); 
  m_sendSocket->SetIpRecvTos(true);
  m_sendSocket->SetIpRecvTtl(true);
  m_sendSocket->BindToNetDevice(m_sendDevice);
  //initate TCP-threehand shaking 
  InetSocketAddress temp2 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_peer).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_peer).GetPort () 
  );
  temp2.SetTos(16);  
  m_sendSocket->Connect (temp2); 
  ...
  InetSocketAddress temp3 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_local_mthreshold).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_local_mthreshold).GetPort () 
  );
  temp3.SetTos(16);
  m_sinkSocket_mthreshold->Bind (temp3);
  ...
  //initate TCP-threehand shaking
  InetSocketAddress temp5 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_peer_mthreshold).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_peer_mthreshold).GetPort () 
  );
  temp5.SetTos(16);
  m_sendSocket_mthreshold->Connect (temp5);
  ...
  InetSocketAddress temp6 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_local_auth).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_local_auth).GetPort () 
  );
  temp6.SetTos(16);
  m_sinkSocket_auth->Bind (temp6);
  ...
  InetSocketAddress temp7 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_peer_auth).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_peer_auth).GetPort () 
  );
  temp7.SetTos(16);
  m_sendSocket_auth->Connect (temp7);
  ...
  InetSocketAddress temp8 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_local_sifting).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_local_sifting).GetPort () 
  );
  temp8.SetTos(16);
  m_sinkSocket_sifting->Bind (temp8);
  ...
  InetSocketAddress temp9 = InetSocketAddress (
    InetSocketAddress::ConvertFrom(m_peer_sifting).GetIpv4 (),
    InetSocketAddress::ConvertFrom(m_peer_sifting).GetPort () 
  );
  temp9.SetTos(16);
