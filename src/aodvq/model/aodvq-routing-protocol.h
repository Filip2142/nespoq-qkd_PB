 ...
 */
#ifndef AODVQROUTINGPROTOCOL_H
#define AODVQROUTINGPROTOCOL_H
...
public:
  ...
  static const uint32_t AODVQ_PORT;
  ...
  void PrintRoutingTable (Ptr<OutputStreamWrapper> stream, std::string additionalData) const;
...
private:
  std::map<uint32_t,Ipv4Address> rrepcache;
  // Protocol parameters.
  uint32_t m_L;
...
private:
   ...
   */
  bool UpdateRouteLifeTime (Ipv4Address addr, Time lt /*,Ptr<NetDevice> oif*/);
  /**
  ...
  void RecvAodvq (Ptr<Socket> socket);
  /// Receive RREQ
