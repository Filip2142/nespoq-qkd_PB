...
{
  static TypeId tid = TypeId ("ns3::aodvq::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodvq")
...
RreqHeader::RreqHeader (uint8_t flags, uint8_t reserved, uint8_t hopCount, uint32_t requestID, Ipv4Address dst,
                        uint32_t dstSeqNo, Ipv4Address origin, uint32_t originSeqNo, uint32_t L, uint32_t L_summary)
  : m_flags (flags),
    m_reserved (reserved),
    m_hopCount (hopCount),
...
{
  static TypeId tid = TypeId ("ns3::aodvq::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodvq")
...
RreqHeader::operator== (RreqHeader const & o) const
{
  return (m_flags == o.m_flags && m_reserved == o.m_reserved
          ...
          && m_L == o.m_L && m_L_summary == o.m_L_summary);
}
...
RrepHeader::RrepHeader (uint8_t prefixSize, uint8_t hopCount, Ipv4Address dst,
                        uint32_t dstSeqNo, Ipv4Address origin, Time lifeTime, uint32_t L, uint32_t L_summary)
  : m_flags (0),
...
{
  static TypeId tid = TypeId ("ns3::aodvq::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodvq")
...
{
  static TypeId tid = TypeId ("ns3::aodvq::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodvq")
...
{
  static TypeId tid = TypeId ("ns3::aodvq::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodvq")
