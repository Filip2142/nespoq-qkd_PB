...
void
QKDHelper::GetL (NodeContainer& n){
    ...
    {   
        m = n.Get(i)->GetObject<QKDManager> ()->FetchLinkThresholdHelpValue();
        Threshold_value_struct a;
        a.thr_value = m;
        a.actualnode = n.Get(i)->GetId();
        m_threshold_struct.push_back(a);
