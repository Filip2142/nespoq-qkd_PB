...
int main (int argc, char *argv[])
{
    ...
    */
    ...
    positionAlloc ->Add(Vector(600, 200, 0)); // node6 
    ...
    QHelper.AddGraph(n.Get(0), d1d2.Get (0), "QKD buffer medzi uzlami 0 a 2"); //srcNode, destinationAddress, BufferTitle
    ...
    NetDeviceContainer qkdNetDevices24 = QHelper.InstallOverlayQKD (
        ...
        va24_2, va24_4,  
        58576,     //min
        68576,     //thr - will be set automatically
        585760,    //max
        585760     //current    //88576 
        

    );
    //Create graph to monitor buffer changes
    QHelper.AddGraph(n.Get(2), d3d4.Get (0), "QKD buffer medzi uzlami 2 a 4"); //srcNode, destinationAddress, BufferTitle
    ...
    //Create graph to monitor buffer changes
    QHelper.AddGraph(n.Get(2), d2d5.Get (0), "QKD buffer medzi uzlami 2 a 5"); //srcNode, destinationAddress, BufferTitle
    ...
    //Create graph to monitor buffer changes
    QHelper.AddGraph(n.Get(4), d4d6.Get (0), "QKD buffer medzi uzlami 4 a 6"); //srcNode, destinationAddress, BufferTitle
    ...
    //Create graph to monitor buffer changes
    QHelper.AddGraph(n.Get(5), d5d6.Get (0), "QKD buffer medzi uzlami 5 a 6"); //srcNode, destinationAddress, BufferTitle
    ...
    //Create graph to monitor buffer changes
    QHelper.AddGraph(n.Get(6), d6d7.Get (0), "QKD buffer medzi uzlami 6 a 8"); //srcNode, destinationAddress, BufferTitle
    ...
    app->Setup (overlaySocket, sourceAddress, sinkAddress, 1040, 0, DataRate ("25kbps"));
